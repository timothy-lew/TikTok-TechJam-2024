            ...
            <div>
                ...
                <form method="PUT" action={`http://localhost:8080/api/items/667c2015fe08ec33cf32e736`} encType="multipart/form-data" target="_parent"> */}
                    ...
                    <div className="flex flex-col mb-4">
                        ...
                        <input name="description"  type="text" className="border border-gray-300 p-2 rounded-lg" defaultValue={listing?.description}/>
                    </div>
                    <div className="flex flex-col mb-4">
                        <label className="text-left">Price</label>
                        <input name="price"  type="text" className="border border-gray-300 p-2 rounded-lg" defaultValue={listing?.price}/>
                    </div>
                    <div className="flex flex-col mb-4">
                        <label className="text-left">Tok Token Price</label>
                        <input name="toktoken"  type="text" className="border border-gray-300 p-2 rounded-lg" defaultValue={listing?.tokTokenPrice}/>
                    </div>
                    <div className="flex flex-col mb-4">
                        <label className="text-left">Quantity</label>
                        <input name="quantity"  type="text" className="border border-gray-300 p-2 rounded-lg" defaultValue={listing?.quantity}/>
                    </div>
                    <div className="flex flex-col mb-4">
                        <label className="text-left">Image</label>
                        <div className="flex mb-4">
                            <img className="mr-4" alt="No Image" style={{height:50, width:50, objectFit: "cover"}} src={`data:image/png;base64, ${listing?.imageUrl}`} />       
