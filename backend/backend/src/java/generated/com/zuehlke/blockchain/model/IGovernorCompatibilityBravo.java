...
public class IGovernorCompatibilityBravo extends Contract {
    ...
    @Deprecated
    protected IGovernorCompatibilityBravo(String contractAddress, Web3j web3j, Credentials credentials, BigInteger gasPrice, BigInteger gasLimit) {
        super(BINARY, contractAddress, web3j, credentials, gasPrice, gasLimit);
    }

    protected IGovernorCompatibilityBravo(String contractAddress, Web3j web3j, Credentials credentials, ContractGasProvider contractGasProvider) {
        super(BINARY, contractAddress, web3j, credentials, contractGasProvider);
    }

    @Deprecated
    protected IGovernorCompatibilityBravo(String contractAddress, Web3j web3j, TransactionManager transactionManager, BigInteger gasPrice, BigInteger gasLimit) {
        super(BINARY, contractAddress, web3j, transactionManager, gasPrice, gasLimit);
    }

    protected IGovernorCompatibilityBravo(String contractAddress, Web3j web3j, TransactionManager transactionManager, ContractGasProvider contractGasProvider) {
    ...
    public RemoteFunctionCall<Tuple10<BigInteger, String, BigInteger, BigInteger, BigInteger, BigInteger, BigInteger, BigInteger, Boolean, Boolean>> proposals(BigInteger param0) {
    ...
    @Deprecated
    public static IGovernorCompatibilityBravo load(String contractAddress, Web3j web3j, Credentials credentials, BigInteger gasPrice, BigInteger gasLimit) {
        return new IGovernorCompatibilityBravo(contractAddress, web3j, credentials, gasPrice, gasLimit);
    }

    @Deprecated
    public static IGovernorCompatibilityBravo load(String contractAddress, Web3j web3j, TransactionManager transactionManager, BigInteger gasPrice, BigInteger gasLimit) {
        return new IGovernorCompatibilityBravo(contractAddress, web3j, transactionManager, gasPrice, gasLimit);
    }

    public static IGovernorCompatibilityBravo load(String contractAddress, Web3j web3j, Credentials credentials, ContractGasProvider contractGasProvider) {
        return new IGovernorCompatibilityBravo(contractAddress, web3j, credentials, contractGasProvider);
    }

    public static IGovernorCompatibilityBravo load(String contractAddress, Web3j web3j, TransactionManager transactionManager, ContractGasProvider contractGasProvider) {
        return new IGovernorCompatibilityBravo(contractAddress, web3j, transactionManager, contractGasProvider);
    }

    public static RemoteCall<IGovernorCompatibilityBravo> deploy(Web3j web3j, Credentials credentials, ContractGasProvider contractGasProvider) {
        return deployRemoteCall(IGovernorCompatibilityBravo.class, web3j, credentials, contractGasProvider, getDeploymentBinary(), "");
    }

    @Deprecated
    public static RemoteCall<IGovernorCompatibilityBravo> deploy(Web3j web3j, Credentials credentials, BigInteger gasPrice, BigInteger gasLimit) {
        return deployRemoteCall(IGovernorCompatibilityBravo.class, web3j, credentials, gasPrice, gasLimit, getDeploymentBinary(), "");
    }

    public static RemoteCall<IGovernorCompatibilityBravo> deploy(Web3j web3j, TransactionManager transactionManager, ContractGasProvider contractGasProvider) {
        return deployRemoteCall(IGovernorCompatibilityBravo.class, web3j, transactionManager, contractGasProvider, getDeploymentBinary(), "");
    }

    @Deprecated
    public static RemoteCall<IGovernorCompatibilityBravo> deploy(Web3j web3j, TransactionManager transactionManager, BigInteger gasPrice, BigInteger gasLimit) {
        return deployRemoteCall(IGovernorCompatibilityBravo.class, web3j, transactionManager, gasPrice, gasLimit, getDeploymentBinary(), "");
    }
