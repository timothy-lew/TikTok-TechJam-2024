...
public class GovernorCompatibilityBravo extends Contract {
    ...
    @Deprecated
    protected GovernorCompatibilityBravo(String contractAddress, Web3j web3j, Credentials credentials, BigInteger gasPrice, BigInteger gasLimit) {
        super(BINARY, contractAddress, web3j, credentials, gasPrice, gasLimit);
    }

    protected GovernorCompatibilityBravo(String contractAddress, Web3j web3j, Credentials credentials, ContractGasProvider contractGasProvider) {
        super(BINARY, contractAddress, web3j, credentials, contractGasProvider);
    }

    @Deprecated
    protected GovernorCompatibilityBravo(String contractAddress, Web3j web3j, TransactionManager transactionManager, BigInteger gasPrice, BigInteger gasLimit) {
        super(BINARY, contractAddress, web3j, transactionManager, gasPrice, gasLimit);
    }

    protected GovernorCompatibilityBravo(String contractAddress, Web3j web3j, TransactionManager transactionManager, ContractGasProvider contractGasProvider) {
    ...
    public RemoteFunctionCall<Tuple4<List<String>, List<BigInteger>, List<String>, List<byte[]>>> getActions(BigInteger proposalId) {
        final Function function = new Function(FUNC_GETACTIONS, 
                Arrays.<Type>asList(new org.web3j.abi.datatypes.generated.Uint256(proposalId)), 
    ...
    public RemoteFunctionCall<BigInteger> quorumVotes() {
        final Function function = new Function(FUNC_QUORUMVOTES, 
                Arrays.<Type>asList(), 
                Arrays.<TypeReference<?>>asList(new TypeReference<Uint256>() {}));
        return executeRemoteCallSingleValueReturn(function, BigInteger.class);
    }
    ...
    @Deprecated
    public static GovernorCompatibilityBravo load(String contractAddress, Web3j web3j, Credentials credentials, BigInteger gasPrice, BigInteger gasLimit) {
        return new GovernorCompatibilityBravo(contractAddress, web3j, credentials, gasPrice, gasLimit);
    }

    @Deprecated
    public static GovernorCompatibilityBravo load(String contractAddress, Web3j web3j, TransactionManager transactionManager, BigInteger gasPrice, BigInteger gasLimit) {
        return new GovernorCompatibilityBravo(contractAddress, web3j, transactionManager, gasPrice, gasLimit);
    }

    public static GovernorCompatibilityBravo load(String contractAddress, Web3j web3j, Credentials credentials, ContractGasProvider contractGasProvider) {
        return new GovernorCompatibilityBravo(contractAddress, web3j, credentials, contractGasProvider);
    }

    public static GovernorCompatibilityBravo load(String contractAddress, Web3j web3j, TransactionManager transactionManager, ContractGasProvider contractGasProvider) {
        return new GovernorCompatibilityBravo(contractAddress, web3j, transactionManager, contractGasProvider);
    }

    public static RemoteCall<GovernorCompatibilityBravo> deploy(Web3j web3j, Credentials credentials, ContractGasProvider contractGasProvider) {
        return deployRemoteCall(GovernorCompatibilityBravo.class, web3j, credentials, contractGasProvider, getDeploymentBinary(), "");
    }

    @Deprecated
    public static RemoteCall<GovernorCompatibilityBravo> deploy(Web3j web3j, Credentials credentials, BigInteger gasPrice, BigInteger gasLimit) {
        return deployRemoteCall(GovernorCompatibilityBravo.class, web3j, credentials, gasPrice, gasLimit, getDeploymentBinary(), "");
    }

    public static RemoteCall<GovernorCompatibilityBravo> deploy(Web3j web3j, TransactionManager transactionManager, ContractGasProvider contractGasProvider) {
        return deployRemoteCall(GovernorCompatibilityBravo.class, web3j, transactionManager, contractGasProvider, getDeploymentBinary(), "");
    }

    @Deprecated
    public static RemoteCall<GovernorCompatibilityBravo> deploy(Web3j web3j, TransactionManager transactionManager, BigInteger gasPrice, BigInteger gasLimit) {
        return deployRemoteCall(GovernorCompatibilityBravo.class, web3j, transactionManager, gasPrice, gasLimit, getDeploymentBinary(), "");
    }
