...
public class IERC1820Registry extends Contract {
    ...
    public static List<InterfaceImplementerSetEventResponse> getInterfaceImplementerSetEvents(TransactionReceipt transactionReceipt) {
        List<Contract.EventValuesWithLog> valueList = staticExtractEventParametersWithLog(INTERFACEIMPLEMENTERSET_EVENT, transactionReceipt);
    ...
    public static InterfaceImplementerSetEventResponse getInterfaceImplementerSetEventFromLog(Log log) {
        Contract.EventValuesWithLog eventValues = staticExtractEventParametersWithLog(INTERFACEIMPLEMENTERSET_EVENT, log);
        InterfaceImplementerSetEventResponse typedResponse = new InterfaceImplementerSetEventResponse();
    ...
    public Flowable<InterfaceImplementerSetEventResponse> interfaceImplementerSetEventFlowable(EthFilter filter) {
        return web3j.ethLogFlowable(filter).map(log -> getInterfaceImplementerSetEventFromLog(log));
    }
    ...
    public static List<ManagerChangedEventResponse> getManagerChangedEvents(TransactionReceipt transactionReceipt) {
        List<Contract.EventValuesWithLog> valueList = staticExtractEventParametersWithLog(MANAGERCHANGED_EVENT, transactionReceipt);
    ...
    public static ManagerChangedEventResponse getManagerChangedEventFromLog(Log log) {
        Contract.EventValuesWithLog eventValues = staticExtractEventParametersWithLog(MANAGERCHANGED_EVENT, log);
        ManagerChangedEventResponse typedResponse = new ManagerChangedEventResponse();
        typedResponse.log = log;
        typedResponse.account = (String) eventValues.getIndexedValues().get(0).getValue();
        typedResponse.newManager = (String) eventValues.getIndexedValues().get(1).getValue();
    ...
    public Flowable<ManagerChangedEventResponse> managerChangedEventFlowable(EthFilter filter) {
        return web3j.ethLogFlowable(filter).map(log -> getManagerChangedEventFromLog(log));
    }
    ...
    public RemoteFunctionCall<String> getInterfaceImplementer(String account, byte[] _interfaceHash) {
        final Function function = new Function(FUNC_GETINTERFACEIMPLEMENTER, 
                Arrays.<Type>asList(new org.web3j.abi.datatypes.Address(160, account), 
                new org.web3j.abi.datatypes.generated.Bytes32(_interfaceHash)), 
    ...
    public RemoteFunctionCall<TransactionReceipt> setInterfaceImplementer(String account, byte[] _interfaceHash, String implementer) {
    ...
    public static RemoteCall<IERC1820Registry> deploy(Web3j web3j, Credentials credentials, ContractGasProvider contractGasProvider) {
        return deployRemoteCall(IERC1820Registry.class, web3j, credentials, contractGasProvider, getDeploymentBinary(), "");
    }
    ...
    public static RemoteCall<IERC1820Registry> deploy(Web3j web3j, Credentials credentials, BigInteger gasPrice, BigInteger gasLimit) {
        return deployRemoteCall(IERC1820Registry.class, web3j, credentials, gasPrice, gasLimit, getDeploymentBinary(), "");
    }
    ...
    public static RemoteCall<IERC1820Registry> deploy(Web3j web3j, TransactionManager transactionManager, ContractGasProvider contractGasProvider) {
        return deployRemoteCall(IERC1820Registry.class, web3j, transactionManager, contractGasProvider, getDeploymentBinary(), "");
    }
    ...
    public static RemoteCall<IERC1820Registry> deploy(Web3j web3j, TransactionManager transactionManager, BigInteger gasPrice, BigInteger gasLimit) {
        return deployRemoteCall(IERC1820Registry.class, web3j, transactionManager, gasPrice, gasLimit, getDeploymentBinary(), "");
    }
