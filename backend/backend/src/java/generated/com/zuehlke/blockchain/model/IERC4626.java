...
public class IERC4626 extends Contract {
    ...
    @Deprecated
    protected IERC4626(String contractAddress, Web3j web3j, Credentials credentials, BigInteger gasPrice, BigInteger gasLimit) {
        super(BINARY, contractAddress, web3j, credentials, gasPrice, gasLimit);
    }

    protected IERC4626(String contractAddress, Web3j web3j, Credentials credentials, ContractGasProvider contractGasProvider) {
        super(BINARY, contractAddress, web3j, credentials, contractGasProvider);
    }

    @Deprecated
    protected IERC4626(String contractAddress, Web3j web3j, TransactionManager transactionManager, BigInteger gasPrice, BigInteger gasLimit) {
        super(BINARY, contractAddress, web3j, transactionManager, gasPrice, gasLimit);
    }

    protected IERC4626(String contractAddress, Web3j web3j, TransactionManager transactionManager, ContractGasProvider contractGasProvider) {
    ...
    public RemoteFunctionCall<String> asset() {
        final Function function = new Function(FUNC_ASSET, 
                Arrays.<Type>asList(), 
    ...
    public RemoteFunctionCall<BigInteger> convertToAssets(BigInteger shares) {
        final Function function = new Function(FUNC_CONVERTTOASSETS, 
    ...
    public RemoteFunctionCall<BigInteger> convertToShares(BigInteger assets) {
        final Function function = new Function(FUNC_CONVERTTOSHARES, 
    ...
    public RemoteFunctionCall<BigInteger> maxDeposit(String receiver) {
        final Function function = new Function(FUNC_MAXDEPOSIT, 
                Arrays.<Type>asList(new org.web3j.abi.datatypes.Address(160, receiver)), 
                Arrays.<TypeReference<?>>asList(new TypeReference<Uint256>() {}));
        return executeRemoteCallSingleValueReturn(function, BigInteger.class);
    }

    public RemoteFunctionCall<BigInteger> maxMint(String receiver) {
        final Function function = new Function(FUNC_MAXMINT, 
                Arrays.<Type>asList(new org.web3j.abi.datatypes.Address(160, receiver)), 
                Arrays.<TypeReference<?>>asList(new TypeReference<Uint256>() {}));
        return executeRemoteCallSingleValueReturn(function, BigInteger.class);
    }
    ...
    public RemoteFunctionCall<BigInteger> maxRedeem(String owner) {
        final Function function = new Function(FUNC_MAXREDEEM, 
                Arrays.<Type>asList(new org.web3j.abi.datatypes.Address(160, owner)), 
                Arrays.<TypeReference<?>>asList(new TypeReference<Uint256>() {}));
        return executeRemoteCallSingleValueReturn(function, BigInteger.class);
    }
    ...
    public RemoteFunctionCall<BigInteger> maxWithdraw(String owner) {
        final Function function = new Function(FUNC_MAXWITHDRAW, 
                Arrays.<Type>asList(new org.web3j.abi.datatypes.Address(160, owner)), 
                Arrays.<TypeReference<?>>asList(new TypeReference<Uint256>() {}));
        return executeRemoteCallSingleValueReturn(function, BigInteger.class);
    }
    ...
    public RemoteFunctionCall<BigInteger> previewDeposit(BigInteger assets) {
        final Function function = new Function(FUNC_PREVIEWDEPOSIT, 
                Arrays.<Type>asList(new org.web3j.abi.datatypes.generated.Uint256(assets)), 
                Arrays.<TypeReference<?>>asList(new TypeReference<Uint256>() {}));
        return executeRemoteCallSingleValueReturn(function, BigInteger.class);
    }
    ...
    public RemoteFunctionCall<BigInteger> previewMint(BigInteger shares) {
        final Function function = new Function(FUNC_PREVIEWMINT, 
                Arrays.<Type>asList(new org.web3j.abi.datatypes.generated.Uint256(shares)), 
                Arrays.<TypeReference<?>>asList(new TypeReference<Uint256>() {}));
        return executeRemoteCallSingleValueReturn(function, BigInteger.class);
    }
    ...
    public RemoteFunctionCall<BigInteger> previewRedeem(BigInteger shares) {
        final Function function = new Function(FUNC_PREVIEWREDEEM, 
                Arrays.<Type>asList(new org.web3j.abi.datatypes.generated.Uint256(shares)), 
                Arrays.<TypeReference<?>>asList(new TypeReference<Uint256>() {}));
        return executeRemoteCallSingleValueReturn(function, BigInteger.class);
    }
    ...
    public RemoteFunctionCall<BigInteger> previewWithdraw(BigInteger assets) {
        final Function function = new Function(FUNC_PREVIEWWITHDRAW, 
                Arrays.<Type>asList(new org.web3j.abi.datatypes.generated.Uint256(assets)), 
                Arrays.<TypeReference<?>>asList(new TypeReference<Uint256>() {}));
        return executeRemoteCallSingleValueReturn(function, BigInteger.class);
    }
    ...
    public RemoteFunctionCall<BigInteger> totalAssets() {
        final Function function = new Function(FUNC_TOTALASSETS, 
                Arrays.<Type>asList(), 
                Arrays.<TypeReference<?>>asList(new TypeReference<Uint256>() {}));
        return executeRemoteCallSingleValueReturn(function, BigInteger.class);
    }
    ...
    @Deprecated
    public static IERC4626 load(String contractAddress, Web3j web3j, Credentials credentials, BigInteger gasPrice, BigInteger gasLimit) {
        return new IERC4626(contractAddress, web3j, credentials, gasPrice, gasLimit);
    }

    @Deprecated
    public static IERC4626 load(String contractAddress, Web3j web3j, TransactionManager transactionManager, BigInteger gasPrice, BigInteger gasLimit) {
        return new IERC4626(contractAddress, web3j, transactionManager, gasPrice, gasLimit);
    }

    public static IERC4626 load(String contractAddress, Web3j web3j, Credentials credentials, ContractGasProvider contractGasProvider) {
        return new IERC4626(contractAddress, web3j, credentials, contractGasProvider);
    }

    public static IERC4626 load(String contractAddress, Web3j web3j, TransactionManager transactionManager, ContractGasProvider contractGasProvider) {
        return new IERC4626(contractAddress, web3j, transactionManager, contractGasProvider);
    }

    public static RemoteCall<IERC4626> deploy(Web3j web3j, Credentials credentials, ContractGasProvider contractGasProvider) {
        return deployRemoteCall(IERC4626.class, web3j, credentials, contractGasProvider, getDeploymentBinary(), "");
    }

    @Deprecated
    public static RemoteCall<IERC4626> deploy(Web3j web3j, Credentials credentials, BigInteger gasPrice, BigInteger gasLimit) {
        return deployRemoteCall(IERC4626.class, web3j, credentials, gasPrice, gasLimit, getDeploymentBinary(), "");
    }

    public static RemoteCall<IERC4626> deploy(Web3j web3j, TransactionManager transactionManager, ContractGasProvider contractGasProvider) {
        return deployRemoteCall(IERC4626.class, web3j, transactionManager, contractGasProvider, getDeploymentBinary(), "");
    }

    @Deprecated
    public static RemoteCall<IERC4626> deploy(Web3j web3j, TransactionManager transactionManager, BigInteger gasPrice, BigInteger gasLimit) {
        return deployRemoteCall(IERC4626.class, web3j, transactionManager, gasPrice, gasLimit, getDeploymentBinary(), "");
    }
