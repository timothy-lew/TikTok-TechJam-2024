...
public class IAMB extends Contract {
    ...
    public static AffirmationCompletedEventResponse getAffirmationCompletedEventFromLog(Log log) {
        Contract.EventValuesWithLog eventValues = staticExtractEventParametersWithLog(AFFIRMATIONCOMPLETED_EVENT, log);
        AffirmationCompletedEventResponse typedResponse = new AffirmationCompletedEventResponse();
    ...
    public Flowable<AffirmationCompletedEventResponse> affirmationCompletedEventFlowable(EthFilter filter) {
        return web3j.ethLogFlowable(filter).map(log -> getAffirmationCompletedEventFromLog(log));
    }
    ...
    public static RelayedMessageEventResponse getRelayedMessageEventFromLog(Log log) {
        Contract.EventValuesWithLog eventValues = staticExtractEventParametersWithLog(RELAYEDMESSAGE_EVENT, log);
        RelayedMessageEventResponse typedResponse = new RelayedMessageEventResponse();
        typedResponse.log = log;
        typedResponse.sender = (String) eventValues.getIndexedValues().get(0).getValue();
        typedResponse.executor = (String) eventValues.getIndexedValues().get(1).getValue();
    ...
    public Flowable<RelayedMessageEventResponse> relayedMessageEventFlowable(EthFilter filter) {
        return web3j.ethLogFlowable(filter).map(log -> getRelayedMessageEventFromLog(log));
    }
    ...
    public static UserRequestForAffirmationEventResponse getUserRequestForAffirmationEventFromLog(Log log) {
        Contract.EventValuesWithLog eventValues = staticExtractEventParametersWithLog(USERREQUESTFORAFFIRMATION_EVENT, log);
        UserRequestForAffirmationEventResponse typedResponse = new UserRequestForAffirmationEventResponse();
        typedResponse.log = log;
        typedResponse.messageId = (byte[]) eventValues.getIndexedValues().get(0).getValue();
        typedResponse.encodedData = (byte[]) eventValues.getNonIndexedValues().get(0).getValue();
    ...
    public Flowable<UserRequestForAffirmationEventResponse> userRequestForAffirmationEventFlowable(EthFilter filter) {
        return web3j.ethLogFlowable(filter).map(log -> getUserRequestForAffirmationEventFromLog(log));
    }
    ...
    public static UserRequestForSignatureEventResponse getUserRequestForSignatureEventFromLog(Log log) {
        Contract.EventValuesWithLog eventValues = staticExtractEventParametersWithLog(USERREQUESTFORSIGNATURE_EVENT, log);
        UserRequestForSignatureEventResponse typedResponse = new UserRequestForSignatureEventResponse();
        typedResponse.log = log;
        typedResponse.messageId = (byte[]) eventValues.getIndexedValues().get(0).getValue();
        typedResponse.encodedData = (byte[]) eventValues.getNonIndexedValues().get(0).getValue();
    ...
    public Flowable<UserRequestForSignatureEventResponse> userRequestForSignatureEventFlowable(EthFilter filter) {
        return web3j.ethLogFlowable(filter).map(log -> getUserRequestForSignatureEventFromLog(log));
    }
    ...
    public static RemoteCall<IAMB> deploy(Web3j web3j, Credentials credentials, ContractGasProvider contractGasProvider) {
        return deployRemoteCall(IAMB.class, web3j, credentials, contractGasProvider, getDeploymentBinary(), "");
    }

    @Deprecated
    public static RemoteCall<IAMB> deploy(Web3j web3j, Credentials credentials, BigInteger gasPrice, BigInteger gasLimit) {
        return deployRemoteCall(IAMB.class, web3j, credentials, gasPrice, gasLimit, getDeploymentBinary(), "");
    }
    ...
    public static RemoteCall<IAMB> deploy(Web3j web3j, TransactionManager transactionManager, ContractGasProvider contractGasProvider) {
        return deployRemoteCall(IAMB.class, web3j, transactionManager, contractGasProvider, getDeploymentBinary(), "");
    }
    ...
    public static RemoteCall<IAMB> deploy(Web3j web3j, TransactionManager transactionManager, BigInteger gasPrice, BigInteger gasLimit) {
        return deployRemoteCall(IAMB.class, web3j, transactionManager, gasPrice, gasLimit, getDeploymentBinary(), "");
    }
