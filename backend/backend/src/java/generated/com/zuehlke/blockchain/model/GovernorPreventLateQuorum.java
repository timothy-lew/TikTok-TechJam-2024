...
public class GovernorPreventLateQuorum extends Contract {
    ...
    @Deprecated
    protected GovernorPreventLateQuorum(String contractAddress, Web3j web3j, Credentials credentials, BigInteger gasPrice, BigInteger gasLimit) {
        super(BINARY, contractAddress, web3j, credentials, gasPrice, gasLimit);
    }

    protected GovernorPreventLateQuorum(String contractAddress, Web3j web3j, Credentials credentials, ContractGasProvider contractGasProvider) {
        super(BINARY, contractAddress, web3j, credentials, contractGasProvider);
    }

    @Deprecated
    protected GovernorPreventLateQuorum(String contractAddress, Web3j web3j, TransactionManager transactionManager, BigInteger gasPrice, BigInteger gasLimit) {
        super(BINARY, contractAddress, web3j, transactionManager, gasPrice, gasLimit);
    }

    protected GovernorPreventLateQuorum(String contractAddress, Web3j web3j, TransactionManager transactionManager, ContractGasProvider contractGasProvider) {
    ...
    public static LateQuorumVoteExtensionSetEventResponse getLateQuorumVoteExtensionSetEventFromLog(Log log) {
        Contract.EventValuesWithLog eventValues = staticExtractEventParametersWithLog(LATEQUORUMVOTEEXTENSIONSET_EVENT, log);
        LateQuorumVoteExtensionSetEventResponse typedResponse = new LateQuorumVoteExtensionSetEventResponse();
        typedResponse.log = log;
        typedResponse.oldVoteExtension = (BigInteger) eventValues.getNonIndexedValues().get(0).getValue();
        typedResponse.newVoteExtension = (BigInteger) eventValues.getNonIndexedValues().get(1).getValue();
    ...
    public Flowable<LateQuorumVoteExtensionSetEventResponse> lateQuorumVoteExtensionSetEventFlowable(EthFilter filter) {
        return web3j.ethLogFlowable(filter).map(log -> getLateQuorumVoteExtensionSetEventFromLog(log));
    }
    ...
    public static ProposalExtendedEventResponse getProposalExtendedEventFromLog(Log log) {
        Contract.EventValuesWithLog eventValues = staticExtractEventParametersWithLog(PROPOSALEXTENDED_EVENT, log);
        ProposalExtendedEventResponse typedResponse = new ProposalExtendedEventResponse();
        typedResponse.log = log;
        typedResponse.proposalId = (BigInteger) eventValues.getIndexedValues().get(0).getValue();
        typedResponse.extendedDeadline = (BigInteger) eventValues.getNonIndexedValues().get(0).getValue();
    ...
    public Flowable<ProposalExtendedEventResponse> proposalExtendedEventFlowable(EthFilter filter) {
        return web3j.ethLogFlowable(filter).map(log -> getProposalExtendedEventFromLog(log));
    }
    ...
    public RemoteFunctionCall<BigInteger> lateQuorumVoteExtension() {
        final Function function = new Function(FUNC_LATEQUORUMVOTEEXTENSION, 
                Arrays.<Type>asList(), 
    ...
    @Deprecated
    public static GovernorPreventLateQuorum load(String contractAddress, Web3j web3j, Credentials credentials, BigInteger gasPrice, BigInteger gasLimit) {
        return new GovernorPreventLateQuorum(contractAddress, web3j, credentials, gasPrice, gasLimit);
    }

    @Deprecated
    public static GovernorPreventLateQuorum load(String contractAddress, Web3j web3j, TransactionManager transactionManager, BigInteger gasPrice, BigInteger gasLimit) {
        return new GovernorPreventLateQuorum(contractAddress, web3j, transactionManager, gasPrice, gasLimit);
    }

    public static GovernorPreventLateQuorum load(String contractAddress, Web3j web3j, Credentials credentials, ContractGasProvider contractGasProvider) {
        return new GovernorPreventLateQuorum(contractAddress, web3j, credentials, contractGasProvider);
    }

    public static GovernorPreventLateQuorum load(String contractAddress, Web3j web3j, TransactionManager transactionManager, ContractGasProvider contractGasProvider) {
        return new GovernorPreventLateQuorum(contractAddress, web3j, transactionManager, contractGasProvider);
    }

    public static RemoteCall<GovernorPreventLateQuorum> deploy(Web3j web3j, Credentials credentials, ContractGasProvider contractGasProvider) {
        return deployRemoteCall(GovernorPreventLateQuorum.class, web3j, credentials, contractGasProvider, getDeploymentBinary(), "");
    }

    @Deprecated
    public static RemoteCall<GovernorPreventLateQuorum> deploy(Web3j web3j, Credentials credentials, BigInteger gasPrice, BigInteger gasLimit) {
        return deployRemoteCall(GovernorPreventLateQuorum.class, web3j, credentials, gasPrice, gasLimit, getDeploymentBinary(), "");
    }

    public static RemoteCall<GovernorPreventLateQuorum> deploy(Web3j web3j, TransactionManager transactionManager, ContractGasProvider contractGasProvider) {
        return deployRemoteCall(GovernorPreventLateQuorum.class, web3j, transactionManager, contractGasProvider, getDeploymentBinary(), "");
    }

    @Deprecated
    public static RemoteCall<GovernorPreventLateQuorum> deploy(Web3j web3j, TransactionManager transactionManager, BigInteger gasPrice, BigInteger gasLimit) {
        return deployRemoteCall(GovernorPreventLateQuorum.class, web3j, transactionManager, gasPrice, gasLimit, getDeploymentBinary(), "");
    }
