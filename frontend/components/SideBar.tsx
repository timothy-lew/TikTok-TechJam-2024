  ...
  return (
    <nav className="flex flex-col justify-center items-start gap-4 px-4">
        ...
        <Link href="/explore" className="flex justify-center items-center gap-2">
          <svg fill={`${pathname==='/explore' ? "rgba(254, 44, 85, 1)" : "rgba(22, 24, 35, 1)"}`} width="32" height="32" viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg">
          {pathname==="/explore" ?
            <>
          ...
          <p className={`${pathname==='/explore' ? 'text-skin-red' : 'text-skin-base'} font-bold text-lg`}>Explore</p>
        </Link>

        <Link href="/friends" className="flex justify-center items-center gap-2">
          <svg fill={`${pathname==='/friends' ? "rgba(254, 44, 85, 1)" : "rgba(22, 24, 35, 1)"}`} width="32" height="32" viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg">
          {pathname==="/friends" ?
            <>
          ...
          <p className={`${pathname==='/friends' ? 'text-skin-red' : 'text-skin-base'} font-bold text-lg`}>Friends</p>
        </Link>

        <Link href="/wallet" className="flex justify-center items-center gap-2">
          <svg fill={`${pathname === '/wallet' ? "rgba(254, 44, 85, 1)" : "rgba(22, 24, 35, 1)"}`} width="32" height="32" viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg">
            {pathname === "/wallet" ? (
              <>
          ...
          <p className={`${pathname === '/wallet' ? 'text-skin-red' : 'text-skin-base'} font-bold text-lg`}>Wallet</p>
        </Link>
