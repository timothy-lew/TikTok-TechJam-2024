...
const SideBar = () => {
  ...
  return (
    <nav className="w-[60px] md:w-[230px] flex flex-col items-start justify-start gap-4 px-4">
      ...
      <Link href="/following" className="flex justify-center items-center gap-2">
      ...
      <Link href="/live" className="flex justify-center items-center gap-2">
